...
<html lang="{{ config('app.locale') }}">
	...
	<head>
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>REEVENTY - MEDAYS {{ date('Y') }}</title>
		{{-- <title>@if (trim($__env->yieldContent('template_header_title')))@yield('template_header_title') | @endif {{ config('app.name', Lang::get('titles.app')) }}</title> --}}
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
						...
						<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-footer__copyright">
									&nbsp;&copy;&nbsp; {{ date('Y') }} | Reeventy&reg;&nbsp; par&nbsp;<a href="https://www.innoveos.com" target="_blank" class="kt-link">INNOVEOS</a>&nbsp;| Tous droits réservés
								</div>
		...
		@auth
			<script>
				window.is_admin = {{auth()->user()->hasRole('admin') ?  "true" : "false" }};
				window.has_upgrade = {{auth()->user()->hasPermission('upgrade') ?  "true" : "false" }};
				window.has_delete = {{auth()->user()->hasPermission('delete') ?  "true" : "false" }};
			</script>
		@endauth
		<!--end::Page Scripts -->
    </body>
