        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'users.store', 'method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('email') ? ' has-error text-danger ' : '' }}">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('first_name') ? ' has-error text-danger ' : '' }}">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('last_name') ? ' has-error text-danger ' : '' }}">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('password_confirmation') ? ' has-error text-danger ' : '' }}">
