...
class DeclineParticipant extends Notification
{
    use Queueable;
    ...
    const  EN_TEMPLATE = 'standard-refuser-en';
    const  FR_TEMPLATE = 'standard-refuser-fr';

    const  EN_TEMPLATE_PRESS = 'presse-refuser-en';
    const  FR_TEMPLATE_PRESS = 'presse-refuser-fr';
