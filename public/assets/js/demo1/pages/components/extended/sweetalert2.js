...
var KTSweetAlert2Demo = function() {
    ...
    var initDemos = function() {
        ...
        $('#kt_sweetalert_demo_6').click(function(e) {
            swal.fire({
                type: 'success',
                title: 'Les participants selectionner sont valider avec succès.',
                showConfirmButton: false,
                timer: 2000
            });

            swal.fire({
                title: 'Souhaitez vous confirmer cette action ?',
                text: "45 Utilisateurs sélectionnés seront validés",
                type: 'warning',
                showCancelButton: true,
                ...
                if (result.value) {
                    swal.fire(
                        'Validés !',
                        'Les participants sélectionnés ont été validés avec succès',
                        'success'
                    )
                }
            });
        ...
        $('#kt_sweetalert_demo_8').click(function(e) {
            swal.fire({
                title: 'Souhaitez vous confirmer cette action ?',
                text: "45 Utilisateurs sélectionnés seront refusés",
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Oui, confirmer',
                cancelButtonText: 'Annuler'
                ...
                if (result.value) {
                    swal.fire(
                        'Refuser !',
                        'Les participants sélectionnés ont été refusés avec succès',
                        'success'
                    )
                }
            });
