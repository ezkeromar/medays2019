...
;(function(root, factory){
    ...
    datetime.strings = {
        en: {
            ...
            time:["Heures","Minutes","Seconds"],
            header: ["Sélectionnez un mois", "Sélectionnez une année", "Sélectionnez une décennie", "Sélectionnez une heure"]
        },
        ...
        init: function(){
            ...
            if(this.view == undefined){
                this.view = {
                    ...
                    date: this.select || new Date("11/09/2019")
                };
            }
