...
<div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
        ...
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default">
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item kt-menu__item--rel">
                    <a href="/participants" class="kt-menu__link">
                ...
                <!-- <li class="kt-menu__item kt-menu__item--rel">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                        ...
                        <span class="kt-menu__link-text">Hebergement</span>
                    </a>
                </li>
                <li class="kt-menu__item kt-menu__item--rel">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                        ...
                        <span class="kt-menu__link-text">Transferts</span>
                    </a>
                </li>
                <li class="kt-menu__item kt-menu__item--rel">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                ...
                <li class="kt-menu__item kt-menu__item--rel">
                    <a href="javascr bipt:;" class="kt-menu__link kt-menu__toggle">
                        <span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <?php if (Auth::check() && Auth::user()->hasRole('admin')): ?>
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                            ...
                            <span class="kt-menu__link-text">Parametres</span>
                            <i class="kt-menu__ver-arrow la la-angle-right"></i>
                        </a>
                        <div class="kt-menu__submenu  kt-menu__submenu--fixed kt-menu__submenu--left" style="width:300px">
                                <div class="kt-menu__subnav">
                                    <ul class="kt-menu__content">
                                        <li class="kt-menu__item ">
                                            <ul class="kt-menu__inner" style="padding-bottom: 0">
                                                <li class="kt-menu__item <?php echo e(Request::is('users', 'users/' . Auth::user()->id, 'users/' . Auth::user()->id . '/edit') ? 'active' : null); ?>" aria-haspopup="true">
                                                ...
                                                <li class="kt-menu__item <?php echo e(Request::is('users/create') ? 'active' : null); ?>" aria-haspopup="true">
                                                ...
                                                <li class="kt-menu__item <?php echo e(Request::is('hotels') ? 'active' : null); ?>" aria-haspopup="true">
                ...
                <?php if (Auth::check() && Auth::user()->hasRole('admin')): ?>
                <li class="kt-menu__item kt-menu__item--rel">
                    <a href="/comments" class="kt-menu__link">
                        <span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="kt-menu__link-text">Commentaires</span>
                    </a>
                </li>
            <?php endif; ?>
            </ul>
    ...
    <div class="kt-header__topbar">
        ...
        <?php echo $__env->make('partials.user-bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- end:: Header Topbar -->
</div>
<!-- end:: Header --><?php /**PATH C:\laragon\www\medyas\resources\views/partials/header.blade.php ENDPATH**/ ?>