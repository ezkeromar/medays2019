...
<html lang="<?php echo e(config('app.locale')); ?>">
	...
	<head>
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>REEVENTY - MEDAYS <?php echo e(date('Y')); ?></title>
		...
		<link href="<?php echo e(asset('assets/css/demo1/style.bundle.css')); ?>" rel="stylesheet" type="text/css" />

		<!--end::Global Theme Styles -->

		<!--begin::Layout Skins(used by all pages) -->
		<link href="<?php echo e(asset('assets/css/demo1/skins/header/base/light.css')); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo e(asset('assets/css/demo1/skins/header/menu/light.css')); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo e(asset('assets/css/demo1/skins/brand/dark.css')); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo e(asset('assets/css/demo1/skins/aside/dark.css')); ?>" rel="stylesheet" type="text/css" />
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<?php if(auth()->guard()->check()): ?>
			<!-- begin:: Header Mobile -->
			<?php echo $__env->make('partials.header-mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			<!-- end:: Header Mobile -->
							...
							<div class="kt-subheader   kt-grid__item" id="kt_subheader">
								<div class="kt-container  kt-container--fluid ">
									...
									<div class="kt-subheader__toolbar">
										<?php echo $__env->yieldContent('template_toolbar'); ?>
									</div>
								</div>
							</div>
						...
						<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-footer__copyright">
									&nbsp;&copy;&nbsp; <?php echo e(date('Y')); ?> | Reeventy&reg;&nbsp; par&nbsp;<a href="https://www.innoveos.com" target="_blank" class="kt-link">INNOVEOS</a>&nbsp;| Tous droits réservés
								</div>
		...
		<script src="<?php echo e(asset('assets/js/demo1/scripts.bundle.js')); ?>" type="text/javascript"></script>
		...
		<?php if(auth()->guard()->check()): ?>
			<script>
				window.is_admin = <?php echo e(auth()->user()->hasRole('admin') ?  "true" : "false"); ?>;
				window.has_upgrade = <?php echo e(auth()->user()->hasPermission('upgrade') ?  "true" : "false"); ?>;
				window.has_delete = <?php echo e(auth()->user()->hasPermission('delete') ?  "true" : "false"); ?>;
			</script>
		<?php endif; ?>
		<!--end::Page Scripts -->
    </body>
    <!-- end::Body -->
</html><?php /**PATH C:\laragon\www\medyas\resources\views/layouts/app.blade.php ENDPATH**/ ?>