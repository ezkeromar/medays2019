...
<html lang="en">
  <head>
    ...
    <!-- <link href="<?php echo e(asset('/jquery.datepick.css')); ?>" rel="stylesheet"> -->
  ...
  <body>
    <header class="header">
      <nav class="navbar">
        ...
        <div class="navbar__logo-burger_container">
          ...
          <a href="/">
            <svg class="navbar__logo">
                <image xlink:href="/img/logo-medays-<?php echo e($lang); ?>.svg"></image>
            </svg>
          </a>
        </div>
        ...
        <h1 class="header__title">
          <?php echo e(__('front.'.$lang.'.title')); ?>

        </h1>
        <ul class="navbar__lang">
          <li class="navbar__item <?php echo e(('fr' == $lang) ? 'redcolor' : ''); ?>">
            <?php if(!empty($participant)): ?>
              <a href="/changelang/fr/<?php echo e($participant->id); ?>">FR</a>
            <?php else: ?>
              <?php if(!empty(app('request')->input('type'))): ?>
                <a href="fr?type=<?php echo e(app('request')->input('type')); ?>">FR</a>
              <?php else: ?>
                <a href="fr">FR</a>
              <?php endif; ?>
            <?php endif; ?>
          ...
          <li class="navbar__separator"></li>
          <li class="navbar__item <?php echo e(('en' == $lang) ? 'redcolor' : ''); ?>">
            <?php if(!empty($participant)): ?>
              <a href="/changelang/en/<?php echo e($participant->id); ?>">EN</a>
            <?php else: ?>
              <?php if(!empty(app('request')->input('type'))): ?>
                <a href="en?type=<?php echo e(app('request')->input('type')); ?>">EN</a>
              <?php else: ?>
                <a href="en">EN</a>
              <?php endif; ?>
            <?php endif; ?>
      ...
      <div class="footer__container">
        <div class="footer__conds-rights">
          <a class="footer__conditions">
            <?php echo e(__('front.'.$lang.'.conditionfooter')); ?>

          </a>
          <a class="footer__rights">
            - - <?php echo e(__('front.'.$lang.'.footerrights')); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('jquery.inputmask.js')); ?>" charset="utf-8"></script>
...
<?php /**PATH C:\laragon\www\medyas\resources\views/registerFront.blade.php ENDPATH**/ ?>