                    ...
                    <div class="kt-widget__content">
                        <div class="kt-widget__section">
                            <span class="kt-widget__username">
                                <span></span> <?php echo e($participant->first_name); ?> <?php echo e($participant->last_name); ?>

                                <i class="flaticon2-correct kt-font-success"></i>
                            </span>
                            <span class="kt-widget__subtitle">
                                <?php echo e($participant->function); ?>
                    ...
                    <div class="kt-widget__content">
                        <div class="kt-widget__info">
                            <span class="kt-widget__label">
                                <span class="kt-widget4__number kt-font-info"><?php echo e($typename); ?></span>
                            </span>
                        </div>
                        <?php if($participant->type_id == 5 || $participant->type_id == 6): ?>
                            <div class="kt-widget__info">
                                <span class="kt-widget__data">
                                    <a href="<?php echo e('/participant/'.$participant->parent_id); ?>"><?php echo e($participantParentName); ?></a>
                                </span>
                            </div>
                        <?php endif; ?>
                        <div class="kt-widget__info">
                            <span class="kt-widget__label">Code d'accès :</span>
                            <span class="kt-widget__data"><?php echo e($participant->access_code); ?></span>
                        </div>
                        <div class="kt-widget__info">
                            <span class="kt-widget__label">WebCode :</span>
                            <span class="kt-widget__data"><?php echo e($participant->webcode); ?></span>
                        </div>
                    </div>
                    <div class="kt-widget__items">
                        <a href="<?php echo e(URL('participant/'.$participant->id)); ?>"
                            class="kt-widget__item <?php echo e($active_link == 'profil' ? 'kt-widget__item--active' : null); ?>">
                        ...
                        <a href="<?php echo e(URL('participant/'.$participant->id.'/prestations')); ?>"
                            class="kt-widget__item <?php echo e($active_link == 'prestations' ? 'kt-widget__item--active' : null); ?>">
                            <span class="kt-widget__section">
                                <span class="kt-widget__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                        ...
                        <?php if($participant->type_id == 4): ?>
                        <a href="<?php echo e(URL('participant/'.$participant->id.'/delegation')); ?>"
                            class="kt-widget__item <?php echo e($active_link == 'delegation' ? 'kt-widget__item--active' : null); ?>">
                            <span class="kt-widget__section">
                                <span class="kt-widget__icon">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(URL('participant/'.$participant->id.'/historique')); ?>"
                            class="kt-widget__item <?php echo e($active_link == 'historique' ? 'kt-widget__item--active' : null); ?>">
                            <span class="kt-widget__section">
                                <span class="kt-widget__icon">
                        ...
                        <a href="<?php echo e(URL('participant/'.$participant->id.'/commentaire')); ?>"
                            class="kt-widget__item <?php echo e($active_link == 'commentaire' ? 'kt-widget__item--active' : null); ?>">
                            <span class="kt-widget__section">
                                <span class="kt-widget__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<!--End:: App Aside--><?php /**PATH C:\laragon\www\medyas\resources\views/partials/participants/side.blade.php ENDPATH**/ ?>