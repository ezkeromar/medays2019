...
<div class="content__step content__step--step4">
            <div class="inscription">
              ...
              <?php if($type_id == 1 ||$type_id == 7): ?>
                <p class="info__desp">
                  <?php echo e(__('front.'.$lang.'.wereceivedinscription')); ?>

                </p>
                <p class="info__desp">
                  <?php echo e(__('front.'.$lang.'.willrespondsoon')); ?>

                </p>
                <p class="info__desp">
                  <?php echo e(__('front.'.$lang.'.salutation')); ?>

                </p>
              <?php else: ?>
                <p class="info__desp">
                  <?php echo e(__('front.'.$lang.'.wereceivedinscription1')); ?>

                </p>
                <p class="info__desp">
                  <?php echo e(__('front.'.$lang.'.willrespondsoon1')); ?>

                </p>
                <p class="info__desp">
                  <?php echo e(__('front.'.$lang.'.salutation1')); ?>

                </p>
              <?php endif; ?>
              <p class="info__desp" style="font-style: italic;">
                <?php echo e(__('front.'.$lang.'.organizationteam')); ?>
            ...
            <div class="info">
              <div class="info__content">
                <div class="info__tips">
                  <h2 class="title__secondary"><?php echo e(__('front.'.$lang.'.confirmation')); ?></h2>
                </div>
                <div class="info__contact">
                  ...
                  <p class="info__desp">
                    ...
                    <?php elseif(!empty($type_id) && $type_id == 2 && $type_id == 3): ?>
...
<?php echo $__env->make('registerFront', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\medyas\resources\views/front/laststep.blade.php ENDPATH**/ ?>